...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'jobs_jobcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_categories', to=orm['jobs.JobPost'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'jobs', ['JobCategory'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'jobs_jobcategory')
    ...
    models = {
        ...
        u'jobs.jobcategory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'job_categories'", 'to': u"orm['jobs.JobPost']"}),
