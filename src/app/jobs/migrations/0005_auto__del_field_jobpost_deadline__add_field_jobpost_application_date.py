...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JobPost.deadline'
        db.delete_column(u'jobs_jobpost', 'deadline')

        # Adding field 'JobPost.application_date'
        db.add_column(u'jobs_jobpost', 'application_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JobPost.deadline'
        db.add_column(u'jobs_jobpost', 'deadline',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 28, 0, 0)),
                      keep_default=False)

        # Deleting field 'JobPost.application_date'
        db.delete_column(u'jobs_jobpost', 'application_date')
