...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'startups_startup_companies', (
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='startup_companies_related', null=True, to=orm['photologue.PhotoEffect'])),
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='startup_companies_created_content', null=True, to=orm['authentication.EndUser'])),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='startup_companies_modified_content', null=True, to=orm['authentication.EndUser'])),
        ...
        # Adding M2M table for field sites on 'startup_companies'
        m2m_table_name = db.shorten_name(u'startups_startup_companies_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('startup_companies', models.ForeignKey(orm[u'startups.startup_companies'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['startup_companies_id', 'site_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sites on 'startup_companies'
        db.delete_table(db.shorten_name(u'startups_startup_companies_sites'))
    ...
    models = {
        ...
        u'startups.startup_companies': {
            ...
            'Meta': {'ordering': "['order', '-publish_at']", 'object_name': 'startup_companies'},
            'contact_details': ('django.db.models.fields.TextField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'startup_companies_created_content'", 'null': 'True', 'to': u"orm['authentication.EndUser']"}),
            'crop_from': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10', 'blank': 'True'}),
            'date_taken': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'startup_companies_related'", 'null': 'True', 'to': u"orm['photologue.PhotoEffect']"}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'startup_companies_modified_content'", 'null': 'True', 'to': u"orm['authentication.EndUser']"}),
