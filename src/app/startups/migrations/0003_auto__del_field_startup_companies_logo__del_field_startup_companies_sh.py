...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'startup_companies.logo'
        db.delete_column(u'startups_startup_companies', 'logo')

        # Deleting field 'startup_companies.short_descriptor'
        db.delete_column(u'startups_startup_companies', 'short_descriptor')

        # Deleting field 'startup_companies.long_descriptor'
        db.delete_column(u'startups_startup_companies', 'long_descriptor')


    def backwards(self, orm):
        # Adding field 'startup_companies.logo'
        db.add_column(u'startups_startup_companies', 'logo',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'startup_companies.short_descriptor'
        db.add_column(u'startups_startup_companies', 'short_descriptor',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'startup_companies.long_descriptor'
        db.add_column(u'startups_startup_companies', 'long_descriptor',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
