...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StartupCompanies'
        db.create_table(u'startups_startupcompanies', (
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='startupcompanies_related', null=True, to=orm['photologue.PhotoEffect'])),
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='startupcompanies_created_content', null=True, to=orm['authentication.EndUser'])),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='startupcompanies_modified_content', null=True, to=orm['authentication.EndUser'])),
        ...
        db.send_create_signal(u'startups', ['StartupCompanies'])

        # Adding M2M table for field sites on 'StartupCompanies'
        m2m_table_name = db.shorten_name(u'startups_startupcompanies_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('startupcompanies', models.ForeignKey(orm[u'startups.startupcompanies'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['startupcompanies_id', 'site_id'])


    def backwards(self, orm):
        # Deleting model 'StartupCompanies'
        db.delete_table(u'startups_startupcompanies')

        # Removing M2M table for field sites on 'StartupCompanies'
        db.delete_table(db.shorten_name(u'startups_startupcompanies_sites'))
    ...
    models = {
        ...
        u'startups.startupcompanies': {
            'Link_to_their_website': ('django.db.models.fields.TextField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'Meta': {'ordering': "['order', '-publish_at']", 'object_name': 'StartupCompanies'},
            'contact_details': ('django.db.models.fields.TextField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'startupcompanies_created_content'", 'null': 'True', 'to': u"orm['authentication.EndUser']"}),
            'crop_from': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10', 'blank': 'True'}),
            'date_taken': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'startupcompanies_related'", 'null': 'True', 'to': u"orm['photologue.PhotoEffect']"}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'startupcompanies_modified_content'", 'null': 'True', 'to': u"orm['authentication.EndUser']"}),
